...
### Load dataset
pat <- "RU1065C_MET_LI_filtered.h5"
system(paste0("aws s3 sync s3://sclc-seq/cellbender/v0.2.0_CellRanger6.1.1/RU1065C_MET_LI/", pat,"/ data/",pat,"/ ","--exclude '*' --include '",pat,"_filtered.h5' "))
